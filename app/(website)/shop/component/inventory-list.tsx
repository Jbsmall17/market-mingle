...
export default function InventoryList({
  ...
  return (
    <div className="relative flex flex-col sm:flex-row overflow-x-auto">
      <div className={`min-w-[225px] pt-4 pb-4 md:pt-6 lg:pt-8 border-r border-black absolute sm:static top-0 left-0 bg-white z-10 pl-4 md:pl-8 lg:pl-10 xl:pl-14 pr-2 ${showFilter ? "block" : "hidden sm:block" } overflow-y-auto`}>
      ...
      <div className="flex flex-col min-h-[1150px] pr-4 md:pr-8 lg:pr-10 xl:pr-14 relative flex-1 pl-4 md:pl-6 sm:min-w-[640px] overflow-x-auto">
